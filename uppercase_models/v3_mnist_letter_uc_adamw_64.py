...
64x64. Pure PyTorch — wider architecture with Squeeze-Excitation attention
blocks. Same architecture and hyperparameters as v3_mnist_digit_adamw_64.py
...
v3_mnist_digit_adamw_64.py — see that file's own docstring /
...
already returns — the same pattern v3_mnist_digit_soap_64.py /
v3_mnist_digit_muon_64.py already use for their own no-supplementary-data
...
Output: ./v3_mnist_letter_uc_adamw_64/  (created next to this script)
"""
