...
optimizer, 28x28. Pure PyTorch — Triple-width channels + Multi-Scale
feature pyramid fusion. Same architecture and hyperparameters as
v3_mnist_digit_soap_28.py (the digit ensemble), retargeted at a 26-class
...
Identical hyperparameters to v3_mnist_digit_soap_28.py — see that file's
...
Output: ./v3_mnist_letter_uc_soap_28/  (created next to this script)
"""
