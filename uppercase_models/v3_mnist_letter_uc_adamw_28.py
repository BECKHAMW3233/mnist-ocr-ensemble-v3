...
blocks. Same architecture and hyperparameters as v3_mnist_digit_adamw_28.py
...
v3_mnist_digit_adamw_28.py — see that file's own docstring /
...
already returns — the same pattern v3_mnist_digit_soap_28.py /
v3_mnist_digit_muon_28.py already use for their own no-supplementary-data
...
Output: ./v3_mnist_letter_uc_adamw_28/  (created next to this script)
"""
