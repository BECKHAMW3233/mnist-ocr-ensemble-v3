...
====================
MNIST digit ensemble — OCRConvNetTriplePyramid, SOAP optimizer, 28x28
Pure PyTorch — Triple-width channels + Multi-Scale feature pyramid fusion.
Adapted from v2's mnist_soap_28.py (32/64/128 tiers) — the
...
Output: ./v3_mnist_digit_soap_28/  (created next to this script)
"""
