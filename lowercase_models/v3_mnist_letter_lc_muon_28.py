...
module, matching v3_mnist_digit_muon_28.py's own convention). Identical
hyperparameters to v3_mnist_digit_muon_28.py — see that file's own
...
#     v3_mnist_digit_muon_28.py's own convention — see that file's
