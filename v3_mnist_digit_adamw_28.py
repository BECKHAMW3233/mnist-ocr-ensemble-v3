...
====================
MNIST digit ensemble — OCRConvNetWide, Schedule-Free AdamW, 28x28
Pure PyTorch — Wider architecture with Squeeze-Excitation attention blocks.
Adapted from v2's mnist_adamw_28.py (32/64/128 tiers) — the
...
Output: ./v3_mnist_digit_adamw_28/  (created next to this script)
"""
