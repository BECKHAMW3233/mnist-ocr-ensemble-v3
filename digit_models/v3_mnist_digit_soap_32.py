...
====================
MNIST digit ensemble — OCRConvNetTriplePyramid, SOAP optimizer, 32x32
Pure PyTorch — Triple-width channels + Multi-Scale feature pyramid fusion.
Adapted from v2's mnist_soap_32.py (32/64/128 tiers) — the 16x16 and
...
Output: ./v3_mnist_digit_soap_32/  (created next to this script)
"""
